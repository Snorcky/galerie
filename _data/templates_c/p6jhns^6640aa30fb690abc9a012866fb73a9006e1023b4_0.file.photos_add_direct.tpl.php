...
/* Smarty version 4.1.0, created on 2023-07-21 12:29:38
  from 'C:\xampp\htdocs\admin\themes\default\template\photos_add_direct.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_64ba5e120c0962_10416699',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6640aa30fb690abc9a012866fb73a9006e1023b4' => 
    array (
      0 => 'C:\\xampp\\htdocs\\admin\\themes\\default\\template\\photos_add_direct.tpl',
      1 => 1688740922,
      2 => 'file',
    ),
  ),
...
function content_64ba5e120c0962_10416699 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="promote-apps">
      <div class="promote-content">
        ...
        <div class="promote-text">
          <span><?php echo strtr(l10n("Piwigo is also on mobile."), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
</span>
          <span><?php echo strtr(l10n("Try now !"), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
</span>
        </div>
        <div class="right-side">
          <div>
            <a href="<?php echo $_smarty_tpl->tpl_vars['PHPWG_URL']->value;?>
/mobile-applications" target="_blank"><span class="go-to-porg icon-link-1"><?php echo strtr(l10n("Discover"), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
</span></a>
          </div>
        </div>
      </div>
      <span class="dont-show-again icon-cancel tiptip" title="<?php echo strtr(l10n('Understood, do not show again'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
"></span>
    </div>
<?php }
